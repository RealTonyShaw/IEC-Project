...
public class UI_Test : MonoBehaviour {
    ...
    void Update()
    {
        ...
        {
            UIText.text = "NOLO   \n"
            //+ "HMD:" + NoloVR_Plugins.API.GetElectricityNumberByDeviceType(0) + " hard:" + NoloVR_Plugins.API.GetNoloHardwareVersionByDeviceType(0) + " soft:" + NoloVR_Plugins.API.GetNoloSoftwareVersionByDeviceType(0) + "\n"
            //+ "left:" + NoloVR_Plugins.API.GetElectricityNumberByDeviceType(1) + " hard:" + NoloVR_Plugins.API.GetNoloHardwareVersionByDeviceType(1) + " soft:" + NoloVR_Plugins.API.GetNoloSoftwareVersionByDeviceType(1) + "\n"
            //      + "right:" + NoloVR_Plugins.API.GetElectricityNumberByDeviceType(2) + " hard:" + NoloVR_Plugins.API.GetNoloHardwareVersionByDeviceType(2) + " soft:" + NoloVR_Plugins.API.GetNoloSoftwareVersionByDeviceType(2) + "\n"
            //            + "base:" + NoloVR_Plugins.API.GetPoseByDeviceType(3).bDeviceIsConnected + " hard:" + NoloVR_Plugins.API.GetNoloHardwareVersionByDeviceType(3) + " soft:" + NoloVR_Plugins.API.GetNoloSoftwareVersionByDeviceType(3) + "\n"
            //            + "so version:" + NoloVR_Plugins.API.GetNoloSoVersion()

            //"LEFT POS:" + NoloVR_Controller.GetDevice(NoloDeviceType.LeftController).GetPose().pos.x.ToString("#0.000");
            //"HMD POS       :" + NoloVR_Controller.GetDevice(NoloDeviceType.Hmd).GetPose().pos
            //+ "HMD ROT       :" + NoloVR_Plugins.GetPose(0).rot + "\n"
